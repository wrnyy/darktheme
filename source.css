:root { 	
    ...
    --background-mobile-header: #2f3136 !important;	
...
.scroller-2FKFPG .systemPad-3UxEGl::-webkit-scrollbar-thumb ., .scroller-2FKFPG .systemPad-3UxEGl::-webkit-scrollbar-track {
    background-clip: padding-box !important;
    border-style: solid !important;
    border-radius: 8px !important;
}
...
.theme-dark .scrollerThemed-2oenus.themedWithTrack-q8E3vB .scroller-2FKFPG::-webkit-scrollbar {
...
.content-ySCtCx, .noSearchResultsContainer-1dVofo {
    background-color: var(--background-secondary);
    height: 280px;
}
...
.theme-dark .theme-light .footer-3rDWdC {
...
.theme-dark .theme-dark .actionIcon-2IISM_, .theme-dark .theme-light .actionIcon-2IISM_ {
...
.theme-dark .regionSelect-3lf4eE, .theme-light .regionSelect-3lf4eE {
...
.userInfoViewing-16kqK3 .flexChild-faoVW3 > div:nth-child(2) .viewBody-2Qz-jg.selectable-x8iAUj {
    filter: blur(5px);
    transition: 300ms cubic-bezier(.2, .11, 0, 1);
}
...
.platform-win.theme-light #user-settings .item-PXvHYJ:nth-of-type(21) {
  transition: 200ms cubic-bezier(0, 0, 0, 1);
  box-shadow: 0 0 0 4px var(--nox-level3), 0 0 0 6px #F04747; }

html:not(.platform-win).theme-light #user-settings .item-PXvHYJ.selected-3s45Ha:nth-of-type(19),
.platform-win.theme-light #user-settings .item-PXvHYJ.selected-3s45Ha:nth-of-type(21) {
  background: #F04747;
  transition: 300ms cubic-bezier(0, 0, 0, 1) !important;
  box-shadow: 0 0 0 0px var(--nox-level3), 0 0 0 3px #F04747; }

html:not(.platform-win).theme-light #user-settings .item-PXvHYJ:nth-of-type(19):active,
.platform-win.theme-light #user-settings .item-PXvHYJ:nth-of-type(21):active {
  background: #F04747; }

html:not(.platform-win).theme-light #user-settings .item-PXvHYJ:nth-of-type(19):hover,
.platform-win.theme-light #user-settings .item-PXvHYJ:nth-of-type(21):hover {
  box-shadow: 0 0 0 0px var(--nox-level3), 0 0 0 3px #F04747;
  transition: 100ms cubic-bezier(0, 0, 0, 1) !important; }
...
.theme-dark .slideBody-2nMrnU, .theme-light .slideBody-2nMrnU {
    background-image: url(https://i.imgur.com/Ip0IAKx.png),url(https://i.imgur.com/hvo4a8V.png);
}

.theme-dark .theme-dark .action-1lSjCi, .theme-dark .theme-light .action-1lSjCi {
...
.message-2qnXI6.mentioned-xhSam7.selected-2P5D_Z, .mouse-mode .mentioned-xhSam7:hover {
...
div[class*="message"] img[src*="583062692596547585"] ~ h2[class^="header"] > span[class*="timestamp"]::before {
  margin-right: .3rem;
  top: -.1rem;
  position: relative;
  font-size: .625rem;
